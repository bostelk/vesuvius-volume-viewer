...
public:
    ...
    Q_INVOKABLE void loadAsync(QUrl source, qsizetype width, qsizetype height, qsizetype depth, QString dataType, QVector3D globalFocusPoint=QVector3D(0,0,0), int level = -1, QString order = "C");
